...
<form name="frm" action="i_action.jsp" style="display: flex; align-items: center; justify-content: center; text-align: center;">
...
<td>
<select name="subcode">
<option value="A001">A001-자바</option> <!-- value가 실제 넘어가는 값이기 때문에 1이 아니라 A001 -->
...
<tr>
<td colspan="2">
<input type="button" value="등록" onclick="return add()">&nbsp;&nbsp; <!-- return 안써도 됌 -->
